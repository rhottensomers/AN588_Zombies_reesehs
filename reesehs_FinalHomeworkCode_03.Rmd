---
title: "reesehs_FinalHomeworkCode_03"
author: "Reese Hotten-Somers"
date: "2023-10-16"
output: rmdformats::readthedown
---
![This zombie is so sad, give them back their hand!](Zombie Picture.png) 
...
wg <- ggplot(data = d, aes(x = age, y = weight)) + geom_point() + xlab("age") + ylab("weight") + theme(legend.position = "bottom", legend.title = element_blank()) #scatter plot with age and weight 
wg
...
```
  As age increases so do both weight and height, indicating a positive linear relationship. The scatter plots demonstrate an upward slope that shows this relationship. However, weight and age have a less linear/postive relationship than age and height as the point are less formed along a line.
